...
contract MesonConfig {
  ...
  bytes25 constant TRON_SIGN_HEADER_32 = bytes25("\x19TRON Signed Message:\n32\n");
  ...
  bytes32 constant RELEASE_TO_TRON_TYPE_HASH = keccak256("bytes32 Sign to release a swap on MesonCONFIG_TESTNET_MODEbytes21 Recipient (tron address in hex format)");
}
